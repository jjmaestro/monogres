...
> mode only at <http://localhost:8080/q/dev/>.
...
You can then execute your native executable with: `./target/monobot-1.0.0-SNAPSHOT-runner`
...
Also for picocli applications the dev mode is supported. When running dev
mode, the picocli application is executed and on press of the Enter key, is
restarted.
